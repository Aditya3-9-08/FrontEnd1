  <main role="main">
    ...
    <section class="router-section" aria-labelledby="dual-band-title">
      ...
      <article class="router-content">
        ...
        <h2 id="dual-band-title">Router dual band adalah router WIFI yang bekerja pada dua frekuensi, yaitu 2.4 GHz dan 5 GHz.</h2>
    ...
    <section class="router-section" aria-labelledby="tri-band-title">
      ...
      <article class="router-content">
        ...
        <h2 id="tri-band-title">Router tri-band adalah router WiFi yang bekerja pada tiga frekuensi sekaligus, yaitu satu 2.4 GHz dan dua band 5 GHz.</h2>
        <p>Kecepatan lalu lintas data sehingga perangkat bisa terhubung ke jaringan yang berbeda. Dengan router tri-band, koneksi internet menjadi lebih cepat, stabil, dan ideal untuk rumah atau kantor dengan banyak perangkat aktif secara bersamaan.</p>
      </article>
    </section>

    <section class="router-section" aria-labelledby="tp-link-title">
      <div class="router-image" role="img" aria-label="White TP-Link router with two antennas on soft blue background, minimalistic and modern for home internet use">
        <img src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/b7d2cc59-6b60-42d9-ab28-6ec80d304ad0.png" alt="White TP-Link router with two antennas on soft blue gradient background, representing practical and economical home internet device" onerror="this.onerror=null; this.src='https://placehold.co/300x300?text=Image+Not+Available';" />
      </div>
      <article class="router-content">
        <h3>TP-Link Router</h3>
        <h2 id="tp-link-title">Router TP-Link dengan dua antena ini merupakan perangkat WiFi yang praktis dan ekonomis.</h2>
        <p>Cocok untuk kebutuhan internet rumah atau kantor kecil. Dengan desain sederhana namun elegan, router ini mampu menghadirkan koneksi nirkabel stabil untuk browsing, streaming ringan, maupun penggunaan perangkat sehari-hari.</p>
      </article>
    </section>
  </main>